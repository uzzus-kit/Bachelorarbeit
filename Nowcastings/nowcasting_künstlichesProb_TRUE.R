...
write.csv(do.call(rbind,SARI_liste),"C:\\Users\\felix\\Desktop\\Uni\\BA\\Daten\\Nowcasts\\Nowcast_künstlichesProb_TRUE.csv",row.names = FALSE)
...
i=1
for (age in ages){
  plotten(Nowcast_darstellung[[age]],age,"00-04 früh True")
  i=i+1
}
