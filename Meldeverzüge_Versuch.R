...
plotten = function(Anteil_x1, Anteil_x2) {
  ...
  # Neue Variable für Färbung
  df_combined = df_combined %>%
    mutate(
      Kategorie = factor(Kategorie, levels = c("Wert_Woche4", "Wert_Woche3", "Wert_Woche2", "Wert_Woche1", "Wert_Woche0")),
      Woche_Datensatz = paste0(Woche, "_", Datensatz),
      Kategorie_Datensatz = paste0(Kategorie, "_", Datensatz)
    )
  df_combined$Kategorie = factor(df_combined$Kategorie, levels = c("Wert_Woche4", "Wert_Woche3", "Wert_Woche2", "Wert_Woche1", "Wert_Woche0"))
  # Farben definieren
  farben = c(
    "Wert_Woche4_Datensatz1" = "#DA70D6",  # orchidee
    "Wert_Woche3_Datensatz1" = "#FFD700",  # gold
    "Wert_Woche2_Datensatz1" = "#90EE90",  # hellgrün
    "Wert_Woche1_Datensatz1" = "#87CEFA",  # hellblau
    "Wert_Woche0_Datensatz1" = "#FFB6C1",  # hellrot
    "Wert_Woche4_Datensatz2" = "#9932CC",   # dunkellila
    "Wert_Woche3_Datensatz2" = "#FFA500",  # orange
    "Wert_Woche2_Datensatz2" = "#228B22",  # waldgrün
    "Wert_Woche1_Datensatz2" = "#4682B4",  # stahlblau
    "Wert_Woche0_Datensatz2" = "#DC143C"   # dunkelrot
  )
  
  ggplot(df_combined, aes(x = Woche_Datensatz, y = Wert, fill = Kategorie_Datensatz)) +
