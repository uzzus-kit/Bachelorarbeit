...
if(run_individually){
  ...
  library(zoo)
  # get functions:
  download.file(url="https://raw.githubusercontent.com/KITmetricslab/RESPINOW-Hub/main/code/baseline/functions.R", destfile = "functions.R")
  download.file(url="https://raw.githubusercontent.com/KITmetricslab/RESPINOW-Hub/main/respinow_viz/functions.R", destfile = "functions.R")
